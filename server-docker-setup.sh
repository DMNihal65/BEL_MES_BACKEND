...
IMAGE_NAME=${IMAGE_NAME:-"bel-fastapi-app-v1.0.0-20250318-162725"}
CONTAINER_NAME=${CONTAINER_NAME:-"bel-fastapi-v1.0.0-20250318-162725"}
PORT=${PORT:-"8002"}
BACKUP_DIR=${BACKUP_DIR:-"/home/smc/bel/backups"}
IMAGE_TAR=${IMAGE_TAR:-"bel-fastapi-app-v1.0.0-20250318-162725.tar"}
