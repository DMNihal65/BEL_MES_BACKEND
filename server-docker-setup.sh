...
IMAGE_NAME=${IMAGE_NAME:-"bel-fastapi-app-v1.5.1-20250516-134638"}
CONTAINER_NAME=${CONTAINER_NAME:-"bel-fastapi-v1.5.1-20250516-134638"}
PORT=${PORT:-"8002"}
BACKUP_DIR=${BACKUP_DIR:-"/home/smc/bel/backups"}
CURRENT_DIR=${CURRENT_DIR:-"/home/smc/bel/current"}
IMAGE_TAR=${IMAGE_TAR:-"bel-fastapi-app-v1.5.1-20250516-134638.tar"}
