...
IMAGE_NAME=${IMAGE_NAME:-"bel-fastapi-app-v15.3.0-20251016-110218"}
CONTAINER_NAME=${CONTAINER_NAME:-"bel-fastapi-v15.3.0-20251016-110218"}
PORT=${PORT:-"8008"}
BACKUP_DIR=${BACKUP_DIR:-"/home/smc/bel/backups"}
CURRENT_DIR=${CURRENT_DIR:-"/home/smc/bel/current"}
IMAGE_TAR=${IMAGE_TAR:-"bel-fastapi-app-v15.3.0-20251016-110218.tar"}
