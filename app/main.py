...
from .api.v1.endpoints import auth, planning, mpp, operations, scheduled, dynamic_rescheduling, comp_maintainance, comp_operator, operator_login, production_logs
...
#uvicorn app.main:app --host 172.18.7.88 --port 8588 --reload
