...
from .api.v1.endpoints import auth, planning, mpp, operations, component_status, programs, daily_production, oee
...
# uvicorn app.main:app --host 172.18.7.88 --port 4479 --reload