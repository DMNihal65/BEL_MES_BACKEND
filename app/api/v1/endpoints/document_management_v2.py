    ...
    try:
        with db_session:
            ...
            if production_order_id:
                base_query = base_query.filter(lambda d: d.production_order and d.production_order.id == production_order_id)
    ...
    try:
        with db_session:
            ...
            try:
                ...
                file_extension = document.latest_version.minio_path.split('.')[-1] if '.' in document.latest_version.minio_path else ''
