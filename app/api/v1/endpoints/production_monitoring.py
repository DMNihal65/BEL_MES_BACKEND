from app.schemas.scheduled import ScheduledOperation, ProductionLogResponse, CombinedScheduleProductionResponse, MachineLiveStatus, MachineStatusHistory, MachineAnalytics, ProductionSummary, StatusChange, PartCount, ProgramChange, MachineSummary, OrderProductionAnalysis, ShiftPerformanceAnalysis, ProductionKPIDashboard, MachineOEEAnalysis, DetailedShiftSummary, MachineStatusTimeline, DailyComparison, MachineComparison,ProductionComparison,ProductionTrend,DailyProductionComparison,ProductionDateRange,DailyProductionData,DailyMachineProduction,OEEMetrics,LossAnalysis,OEETrend,OEELosses, OverallOEEAnalysis
...
from app.schemas.scheduled import ScheduledOperation, ScheduleResponse, ProductionMetrics, MachineStatus, ProductionKPI, ShiftSummary
                            ...
                            if status.job_in_progress:
                                try:
                                    ...
                                    if schedule_item:
                                        ...
                                        if operation:
                                            print(f"Found operation: ID={operation.id}, Number={operation.operation_number}, Description={operation.operation_description}")
            ...
            for machine in machines:
                ...
                if not machine_summary:
                    ...
                    summaries.append(DetailedShiftSummary(
                        ...
                        machine_name=f"{machine.work_center.code}-{machine.make}",
                        production_time=str(machine_summary.production_time) if machine_summary.production_time else "00:00:00",
